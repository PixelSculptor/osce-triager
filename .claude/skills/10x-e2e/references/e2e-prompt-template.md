...
Use this when you want a single E2E test directly from a prompt, without driving
the browser live. It rests on the same discipline as a unit-test generation
prompt: concrete, risk-tied input plus a separately verified behavioral
assertion. E2E adds two fields to that contract: which system boundaries must be
**real**, and what to **mock** at the network layer.
