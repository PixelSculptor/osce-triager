...
Same discipline as for unit tests, lifted to E2E: **never say "fix this test."**
Name the specific anti-pattern, explain why it doesn't protect the risk (or why
it produces false failures), and give the target pattern. Three elements per
re-prompt: _what's wrong_, _why it doesn't protect the risk_, _what replaces
it_.
