...
- **Claude Code** ładuje `CLAUDE.md` z katalogu użytkownika (`~/.claude/CLAUDE.md`), katalogu głównego repozytorium i dowolnego podkatalogu, w którym pracuje agent. Głębsze pliki nadpisują lub uzupełniają wyższe. Reguły implementacyjne dotyczące repozytorium wybieraj z @AGENTS.md
