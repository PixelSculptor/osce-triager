...
| D-01 | project-documentation                      | (dokumentacja) README.md eksponujące projekt jako portfolio dla rekrutera: intro, 4 badges, demo GIF, stack, architektura, Mermaid ERD, 45 testów, MIT license      | S-08, T-06        | —                                             | done   |
...
- **Równolegle z:** —
- **Blokady:** —
- **Podejście:** 2 fazy — (1) Visual assets: 5 screenshotów
  (`docs/screenshots/`), (2) README.md: 10 sekcji EN. Pełny plan:
  `context/changes/project-documentation/plan.md`.
- **Status:** done — zaimplementowane 2026-06-16 (branch
  `project-documentation`, commity `2f34572`–`63c9913`; GitHub issue #48
  zamknięte). 5 screenshotów (login, dashboard, session, results,
  session-details), README 188 linii: tagline + CI badge + live URL, Problem &
  Context, Tech Stack (14 wierszy), Key Features (8), Architecture (moduły + 5
  decyzji), Database Schema (9 tabel), Testing (45 testów, 8 ryzyk), CI/CD (3
  workflows), Local Development. Impl-review 2026-06-17 (issue #50): intro
  paragraph (About block), 4 badges (TypeScript/Next.js/Cloudflare/MIT), Mermaid
  ERD w Database Schema, demo GIF (`docs/demo.gif`) +
  `scripts/generate-demo-gif.sh`, MIT LICENSE.
...
| D-01             | project-documentation  | [D-01] README.md — dokumentacja portfolio projektu                      | done                  | Zaimplementowane 2026-06-16; GitHub issue #48 zamknięte. Impl-review improvements 2026-06-17; GitHub issue #50 zamknięte                                  |
...
| D-01 | project-documentation                      | README.md: intro paragraph, 4 badges, demo GIF, Mermaid ERD, 10 sekcji EN, MIT LICENSE — impl-review improvements 2026-06-17 | 2026-06-17 | `2f34572`–`63c9913` |
