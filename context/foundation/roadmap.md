...
| D-01 | project-documentation                      | (dokumentacja) README.md eksponujące projekt jako portfolio dla rekrutera: tagline, demo GIF, stack, architektura, Mermaid ERD + CI/CD, 45 testów, lokalne uruchomienie | S-08, T-06        | —                                             | done   |
...
| D-01             | project-documentation  | [D-01] README.md — dokumentacja portfolio projektu                      | done                  | Zaimplementowane 2026-06-16; GitHub issue #48 zamknięte                                                                                                   |
...
| D-01 | project-documentation                      | README.md 188 linii: tagline + CI badge + live URL, 5 screenshotów, 10 sekcji EN (Problem, Stack, Features, Architecture, DB Schema, Testing, CI/CD, Local Dev) | 2026-06-16 | `2f34572`–`63c9913` |
